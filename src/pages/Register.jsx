...
export const Register = () => {
    ...
    return (
        <div className='flex w-full h-full bg-white justify-center items-center'>
            <form className='flex flex-col items-center justify-center w-[25%] bg-alabaster-200 border-4 border-black p-4 py-10'>
                ...
                <div className='flex w-full justify-center relative mt-10 px-6 bg-alabaster-200'>
                    ...
                    <input type='text' className='w-full border-2 border-green-700 bg-alabaster-200 p-3 pr-10' />
                </div>
